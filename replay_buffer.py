...
class ReplayBuffer:  # for off-policy
	...
	def sample_batch(self, batch_size, her_rate=0, indices=None) -> tuple:
		...
		if her_batch_size > 0:
			...
			# recompute
			next_trans_dict.rew[:her_batch_size] = self.EP.compute_reward(next_info_dict.ag, fut_ag, AttrDict(goal_mask=next_info_dict.goal_mask, if_press_block=next_info_dict.if_press_block))
		return AttrDict(
